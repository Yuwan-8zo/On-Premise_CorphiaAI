...
export default function Chat() {
    ...
    return (
        ...
        <div className="flex fixed inset-0 w-full h-[100dvh] bg-white dark:bg-[#1C1815] text-corphia-ink dark:text-corphia-ivory overflow-hidden font-sans selection:bg-ios-blue-light/30 relative transition-colors">
            ...
            <main className="flex-1 flex flex-col min-w-0 h-full relative transition-all duration-300 bg-white dark:bg-[#1C1815]">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full px-2 md:px-0">
                                    {((mainProps.t('chat.suggestions', { returnObjects: true }) as { title: string, desc: string }[]) || [
                                        ...
                                        <button 
                                            ...
                                            className="text-left p-4 rounded-[20px] border border-transparent dark:border-white/10 bg-[#F6F5F3] dark:bg-[#282828] hover:bg-[#EFECE7] dark:hover:bg-[#383838] shadow-none hover:shadow-sm transition-all duration-200 group active:scale-[0.98]"
                                        >
