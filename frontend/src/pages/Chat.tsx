...
export default function Chat() {
    ...
    return (
        ...
        <div className="flex fixed inset-0 w-full h-[100dvh] bg-[#F7F6F4] dark:bg-[#1C1815] text-[#2B2B2B] dark:text-white overflow-hidden font-sans selection:bg-ios-blue-light/30 relative transition-colors">
            ...
            <main className="flex-1 flex flex-col min-w-0 h-full md:h-[calc(100vh-24px)] md:my-3 md:mr-3 md:ml-3 relative transition-all duration-300 bg-[#FFFFFF] dark:bg-[#1C1815] md:rounded-[38px] shadow-[0_8px_24px_rgba(0,0,0,0.06)] z-10 overflow-hidden">
