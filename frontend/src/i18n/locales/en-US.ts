...
export default {
    ...
    auth: {
        ...
        contactAdminTitle: 'Can\'t sign in?',
        contactAdminBody: 'Please contact your IT administrator to reset the password. For on-premise data sovereignty, this system does not offer self-service email reset.',
        registerSuccessReLogin: 'Account created. Please sign in with your new credentials.',
    },
    ...
    admin: {
        ...
        audit: {
            ...
            securityEventsOnly: 'Security Events Only',
            actionTypes: {
                ...
                prompt_injection_blocked: 'Injection Blocked',
                dlp_hit: 'DLP Hit',
                account_locked: 'Account Locked',
                token_revoke: 'Token Revoked',
                ngrok_start: 'ngrok Started',
            },
            resourceTypes: {
                auth: 'Auth',
                user: 'User',
        ...
        tenants: {
            title: 'Tenants',
            count: '({{count}})',
            activeTenants: '{{count}} tenants',
            addTenant: 'Add',
            search: 'Search tenants...',
            noTenants: 'No tenants',
            users: 'Users',
            documents: 'Documents',
            messages24h: '24h Messages',
