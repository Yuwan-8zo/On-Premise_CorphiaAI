...
export default {
    ...
    auth: {
        ...
        welcomeTitle: 'ようこそ',
        localDeploy: 'オンプレミス',
        subtitle: 'あなたのプライベート知識ワークスペース',
        engineDesc: 'プライベート知識、ローカル推論、追跡可能な回答',
        ...
        contactAdminTitle: 'ログインできませんか？',
        contactAdminBody: 'パスワードのリセットは IT 管理者にお問い合わせください。データ主権と完全オフライン運用のため、本システムでは自動メール再設定を提供していません。',
        registerSuccessReLogin: '登録が完了しました。新しいアカウントでログインしてください。',
    },
    ...
    admin: {
        ...
        overview: {
            ...
            securityEvents: 'セキュリティイベント (24h)',
            llmHealth: 'LLM リアルタイムステータス',
            systemResources: 'システムリソース',
            piiDetected: 'PII 検出',
            injectionBlocked: 'インジェクション検出',
            dlpHit: 'DLP ヒット',
            loginFailed: 'ログイン失敗',
            tokensPerSec: 'トークン/秒',
            totalGenerations: 'レスポンス回数',
            modelLoaded: 'モデル読み込み',
            modelStandby: 'モデル待機中',
            cpuUsage: 'CPU',
            ramUsage: 'メモリ',
        ...
        users: {
            title: 'ユーザー',
            count: '({{count}})',
            activeOperators: '{{active}} 人のアクティブ',
            addUser: '追加',
            noUsers: 'ユーザーなし',
            forceLogout: 'ログアウト強制',
            table: {
        ...
        audit: {
            ...
            securityEventsOnly: 'セキュリティイベントのみ',
            actionTypes: {
                ...
                pii_detected: 'PII検出',
                prompt_injection_blocked: 'インジェクション攻撃ブロック',
                dlp_hit: 'DLPヒット',
        ...
        system: {
            ...
            clearCache: 'キャッシュクリア',
            reindexVector: 'インデックス再構築',
            restartService: '再起動',
            realTimeHealth: 'リソース',
            resourceMonitoring: 'リソース監視',
            uptime: 'Uptime',
            dbPool: 'DB Pool',
            model: 'モデル',
            platform: 'プラットフォーム',
        ...
        tenants: {
            title: 'テナント',
            count: '({{count}})',
            activeTenants: '{{count}} テナント',
            addTenant: '追加',
            search: 'テナントを検索...',
            noTenants: 'テナントなし',
            users: 'ユーザー',
            documents: 'ドキュメント',
            messages24h: '24時間メッセージ',
            events24h: '24時間イベント',
            table: {
                name: '名前',
                description: '説明',
