    ...
    return (
        <div className="relative flex items-center" ref={menuRef}>
            <button
                ...
                disabled={disabled}
                className="flex items-center gap-1.5 p-2 rounded-full transition-colors text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-ios-dark-gray4 disabled:opacity-50"
