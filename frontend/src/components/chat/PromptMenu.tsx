...
export function PromptMenu({ onSelect, disabled }: PromptMenuProps) {
    ...
    return (
        <div className="relative flex items-center" ref={menuRef}>
            ...
            {/* 下拉選單 */}
            {isOpen && (
                <div className="absolute bottom-full left-0 mb-2 w-48 sm:w-56 bg-corphia-ivory dark:bg-corphia-obsidian rounded-2xl shadow-xl border border-gray-200/50 dark:border-white/10 overflow-hidden transform-gpu z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
