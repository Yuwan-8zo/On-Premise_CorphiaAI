        ...
        <>
            ...
            >
                <div className="max-w-3xl mx-auto px-4 md:px-0 w-full relative flex items-end gap-2">
                    ...
                    {/* 憭惜??????*/}
                    <div className="relative flex-1 flex flex-col bg-corphia-ivory dark:bg-corphia-espresso border border-ios-light-gray5 dark:border-white/5 rounded-[30px] shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] transition-colors focus-within:ring-4 focus-within:border-[rgb(var(--color-ios-accent-light))] dark:focus-within:border-[rgb(var(--color-ios-accent-dark))] focus-within:ring-[rgb(var(--color-ios-accent-light)/0.15)] dark:focus-within:ring-[rgb(var(--color-ios-accent-dark)/0.15)]">
