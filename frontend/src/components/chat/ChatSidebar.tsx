    ...
    return (
        <aside
            className={`${sidebarOpen 
                ...
                } bg-bg-surface rounded-r-[20px] md:rounded-[38px] md:border-r border-border-subtle transition-all duration-300 ease-in-out shrink-0 flex flex-col z-50 absolute md:relative h-full md:h-[calc(100vh-24px)] md:my-3 md:ml-3`}
        >
