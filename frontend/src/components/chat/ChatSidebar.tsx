    ...
    return (
        <aside
            className={`${sidebarOpen 
                ...
                } bg-bg-base/85 supports-[backdrop-filter]:bg-bg-base/70 backdrop-blur-xl rounded-r-[20px] md:rounded-[38px] md:border-r border-border-subtle transition-[width,transform] duration-300 ease-in-out shrink-0 flex flex-col z-50 absolute md:relative h-full md:h-[calc(100vh-24px)] md:my-3 md:ml-3`}
        >
