                                ...
                                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }}>
                                    ...
                                    <div className="mt-8 p-6 bg-gray-50 dark:bg-[#111]/50 rounded-[24px]">
                                        <div className="grid grid-cols-2 gap-y-6 gap-x-8 text-[15px]">
                                            ...
                                            <div>
                                                <p className="text-gray-500 dark:text-gray-400 mb-1 text-sm font-medium">??鞈?摨?/p>
                                                <p className="text-gray-900 dark:text-gray-100 font-semibold text-lg">ChromaDB</p>
                                            </div>
                                            <div>
                                                <p className="text-gray-500 dark:text-gray-400 mb-1 text-sm font-medium">??</p>
