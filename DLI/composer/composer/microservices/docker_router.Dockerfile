...
RUN apk add --no-cache python3 py3-pip pkgconf freetype-dev libpng-dev build-base curl
RUN pip install fastapi==0.111.0 uvicorn==0.29.0 docker==7.0.0 pydantic==2.7.1 requests==2.31.0
RUN pip install langchain==0.3.18 langchain-nvidia-ai-endpoints==0.3.9 pyvis networkx
